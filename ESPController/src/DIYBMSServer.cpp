...
void DIYBMSServer::monitor2(AsyncWebServerRequest *request)
{
  ...
  //current
    ...
    if ( verOneParam.currentM > -200 && verOneParam.currentM < 200 )
    {
      response->print(verOneParam.currentM);
    }
    else
    {
      response->print("0");
                               ...
                               void (*sdcardaction_callback)(uint8_t action))
{
  ...
  //_myserver->on("underconstruction.json", HTTP_POST, DIYBMSServer::handleUnderconstruction);
