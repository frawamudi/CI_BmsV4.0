    ...
    $.getJSON("monitor2.json", function (jsondata) {
        ...
        if (jsondata.current) {
            if (jsondata.current[0] == null) {
                ...
                $("#current .v").html((parseFloat(jsondata.current[0])).toFixed(2) + "A");
                $("#current").show(); 

                /*if (jsondata.current[1] == "D") {
                   $("#current .v").html((parseFloat(jsondata.current[0])).toFixed(2) + "D");
                    $("#current").show(); 
                }else{
                    $("#current .v").html((parseFloat(jsondata.current[0])).toFixed(2) + "C");
                    $("#current").show(); 
                } */    
            }
        }
